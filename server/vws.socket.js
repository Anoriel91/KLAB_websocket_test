 ...
 */
Server.prototype.config = function ( port ) {
...
function init(){
  ...
  if ( !this.config ) throw new Error('Requires a port to listen !');
  ...
  server.listen( this.config, function(){
    ...
    console.log( new Date() + ' - Server is listening on port: ', this.config );

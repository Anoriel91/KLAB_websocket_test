window.Socket = (function(){
  ...
  Socket.prototype.on = function ( topic, callback ) {
    ...
    console.log('CALLBACK : ' + this.handler[ topic ].indexOf( callback ));
    console.log('TOPIC : ' + topic);
    this.handler[ topic ].push( callback );
    
    console.log('HANDLER SIZE: ' + this.handler[topic].length);
  };
  ...
  function init ( autoReconnect ) {
    ...
    var socket  = this.socket,
        events  = [ 'open', 'message', 'close', 'error', 'reconnect', 'broadcast', 'messages', 'hello' ],
